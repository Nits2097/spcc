...
class macro{
	public static void main(String args[]) throws  IOException{
		...
		System.out.print("\n\nPREVIOUS ARGUMENT LIST ARRAY");
		for(i=0;i<plac;i++){
			System.out.print("\n"+platable[i]);
		}

		System.out.print("\n\nCURRENT ARGUMENT LIST ARRAY");
		for(i=0;i<clac;i++){
			System.out.print("\n"+clatable[i]);
		}
		br.close();
...
MAKE CHANGES:
MNT LIST HAS MDT INDEX ALSO
MDT LIST HAS INDEX ALSO
OUTPUT: both on command line, and files are created for each
